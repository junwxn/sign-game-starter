 ...
 * the landmark clips: default variants are used except EATo, whose Flat-O
 * hand-to-mouth motion matches the collected data. Replace mediaUrl values
...
export const SIGN_REFERENCES: Record<string, SignReference> = {
  ...
  eat: {
    variant: 'EATo',
    mediaType: 'image',
    mediaUrl: 'https://blogs.ntu.edu.sg/sgslsignbank/files/formidable/3/gif_eat_signer3_v1-2b6918.gif',
    sourceUrl: `${WORD_PAGE}Eat`,
  },
  finish: {
    variant: 'FINISH-A',
    mediaType: 'image',
    mediaUrl: 'https://blogs.ntu.edu.sg/sgslsignbank/files/formidable/3/gif_finish_signer5_v1-b8ae40.gif',
  ...
  good: {
    variant: 'GOOD-A',
    mediaType: 'image',
    mediaUrl: 'https://blogs.ntu.edu.sg/sgslsignbank/files/formidable/3/gif_good_signer4_v1-14bed6.gif',
  ...
  morning: {
    variant: 'MORNINGb',
    mediaType: 'image',
    mediaUrl: 'https://blogs.ntu.edu.sg/sgslsignbank/files/formidable/3/gif_morning_signer3_v1-c0982a.gif',
    sourceUrl: `${WORD_PAGE}Morning`,
  },
  now: {
    variant: 'NOW-A',
    mediaType: 'image',
    mediaUrl: 'https://blogs.ntu.edu.sg/sgslsignbank/files/formidable/3/gif_now_signer6_v2-f47021.gif',
  ...
  want: {
    variant: 'WANT',
    mediaType: 'image',
    mediaUrl: 'https://blogs.ntu.edu.sg/sgslsignbank/files/formidable/3/gif_want_signer6_v1-b7f8bc.gif',
    sourceUrl: `${WORD_PAGE}Want`,
  },
  where: {
    variant: 'WHERE',
    mediaType: 'image',
    mediaUrl: 'https://blogs.ntu.edu.sg/sgslsignbank/files/formidable/3/gif_where_signer4_v1-14dc73.gif',
