import { GameButton, Overlay, Stars } from "@/components/game/kit";
import { art, signById } from "@/game/data";
  ...
  return (
    <Overlay labelledBy="hint-title">
      <div className="panel w-full max-w-md space-y-3 p-5">
        ...
        <div className="grid place-items-center rounded-xl border-[3px] border-dashed border-ink/40 bg-sky-soft p-4">
