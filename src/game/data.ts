...
const LEGACY_SIGNS: Sign[] = [
  ...
  },
  {
    ...
    category: "Needs",
    emoji: "🍚",
    handShape: "A-hand held near the mouth.",
    movement: "Rotate the wrist inward near the mouth, like using a spoon.",
    mistake: "Using the Flat-O EATo variant instead of the trained EATa variant.",
